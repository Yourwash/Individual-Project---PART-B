...
--
-- Table structure for table `trainers_per_courses`
--

DROP TABLE IF EXISTS `trainers_per_courses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trainers_per_courses` (
...
--
-- Dumping data for table `trainers_per_courses`
--

LOCK TABLES `trainers_per_courses` WRITE;
/*!40000 ALTER TABLE `trainers_per_courses` DISABLE KEYS */;
/*!40000 ALTER TABLE `trainers_per_courses` ENABLE KEYS */;
UNLOCK TABLES;
