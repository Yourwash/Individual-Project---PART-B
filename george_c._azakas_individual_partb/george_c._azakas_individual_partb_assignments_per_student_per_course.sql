...
CREATE TABLE `assignments_per_student_per_course` (
  ...
  CONSTRAINT `fk_assignments_has_students_per_courses_students_per_courses1` FOREIGN KEY (`students_per_courses_students_studentKey`, `students_per_courses_courses_courseKey`) REFERENCES `students_per_course` (`students_studentKey`, `courses_courseKey`)
